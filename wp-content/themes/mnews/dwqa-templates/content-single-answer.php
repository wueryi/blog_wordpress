...
<div class="<?php echo dwqa_post_class() ?>">
	...
	<div class="dwqa-answer-meta">
		...
		<?php printf( __( '<span><a href="%s">%s%s</a> %s answered %s ago</span>', 'dwqa' ), get_author_posts_url( $user_id ), salong_get_avatar( $user_id, get_the_author() ), get_the_author(), dwqa_print_user_badge( $user_id ), human_time_diff( get_post_time( 'U', true ) ) ) ?>
