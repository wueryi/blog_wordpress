    ...
    <div class="wrapper">
        ...
        <section class="content" id="scroll">
            <section class="content_left">
                <ul class="ajaxposts">
                    <?php $paged=( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;$args=array( 'post_type'=> 'post','ignore_sticky_posts' => 1,'meta_key'=> $meta_key,'orderby' => $orderby,'paged' => $paged );$temp_wp_query = $wp_query;$wp_query = null;$wp_query = new WP_Query( $args ); $i = 0; if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) : $wp_query->the_post(); if($i==$salong['ad_post_flow_show_count']){ salong_ad('post_flow'); }$i++;//输出广告 ?>
                    <li class="ajaxpost">
